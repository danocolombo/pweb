...
import danoHeadshot from 'assets/img/faces/dano-2016.jpg';
import pageImage from '../../assets/img/sections/lochsa-river-fall.jpg';
...
export default function ProfilePage({ ...rest }) {
    ...
    return (
        <div>
            ...
            />
            <Parallax
                image={require('assets/img/page-headers/lochsa-river-fall.jpg')}
                // filter='dark'
            ...
            <div className={classNames(classes.main, classes.mainRaised)}>
                <div className={classes.container}>
                    ...
                    >
                        <p>
                            Long-time software engineer, driven by innovation
                            and intrigue by talent.{' '}
                        </p>
                    </div>
