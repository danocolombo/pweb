...
import guacSquare from "assets/img/food/guac-square.png";
...
export default function SectionFood() {
  ...
  return (
    <div className={classes.section}>
      <h2 className={classes.title}>We cannot live on caffine alone...</h2>
      <h5 className={classes.description}>
        We might be able to think that we can just swig the coffee and grab 
        a snack from time to time; but we do need to break up the monotony, 
        and what better way to do it than with some good grub.
        </h5>
      <div>
        <GridContainer>
            ...
            <Card profile plain className={classes.card3}>
              <GridContainer>
                <GridItem xs={12} sm={5} md={5}>
                  <CardHeader image plain>
                    <a href="#pablo" onClick={e => e.preventDefault()}>
                      <img src={guacSquare} alt="..." />
                    </a>
                    <div
                      className={classes.coloredShadow}
                      style={{
                        backgroundImage: `url(${guacSquare})`,
                        opacity: "1"
                      }}
                    />
                  </CardHeader>
                ...
                <GridItem xs={12} sm={7} md={7}>
                  <CardBody plain>
                    <h4 className={classes.cardTitle}>Gun Powder Guacamole</h4>
                    {/* <Muted>
                      <h6 className={classes.cardCategory}>FOUNDER</h6>
                    </Muted> */}
                    <p className={classes.description}>
                      No better way to get those good fats than with a little flavorful kick
                    </p>
                  </CardBody>
