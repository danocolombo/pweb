        ...
        <div className={classes.container}>
          <GridContainer>
            <GridItem xs={12} sm={6} md={6}>
              <h1 className={classes.title}>and here we are...</h1>
              <h4>
                Welcome to my little dot on the internet. Not sure how you found
                me or what you might be looking for, but here you are.
              </h4>
              <br />
            </GridItem>
          </GridContainer>
